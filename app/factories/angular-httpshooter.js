(function () {
	...
	$httpshooter.$inject = ['$http', '$q', '$timeout', '$rootScope', 'shootConfig','$localStorage','$sessionStorage','$state'];

	function $httpshooter($http, $q, $timeout, $rootScope, shootConfig,$localStorage,$sessionStorage,$state) {
